...
<%@page import="entity.Account"%>
 <!--begin of menu-->
        <nav class="navbar navbar-expand-md navbar-dark bg-dark">
            <div class="container">
                <a class="navbar-brand" href="home">Kid Toys Store</a>
        ...
        <section class="jumbotron text-center">
            <div class="container">
                <h1 class="jumbotron-heading">Siêu thị đồ chơi chất lượng cao</h1>
                <p class="lead text-muted mb-0">Sản phẩm uy tín chất lượng cao</p>
            </div>
        </section>
        <!--end of menu-->
